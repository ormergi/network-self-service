...
import (
	...
	"github.com/ormergi/network-self-service/api/v1alpha1"

	"github.com/ormergi/network-self-service/internal/render"
)
...
//+kubebuilder:rbac:groups=selfservice.cnv,resources=overlaynetworks,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=selfservice.cnv,resources=overlaynetworks/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=selfservice.cnv,resources=overlaynetworks/finalizers,verbs=update
