...
type UserDefinedNetworkSpec struct {
	...
	// Foo is an example field of UserDefinedNetwork. Edit userdefinednetwork_types.go to remove/update
	Foo string `json:"foo,omitempty"`
}

// UserDefinedNetworkStatus defines the observed state of UserDefinedNetwork
...
// UserDefinedNetwork is the Schema for the userdefinednetworks API
...
func init() {
	SchemeBuilder.Register(&UserDefinedNetwork{}, &UserDefinedNetworkList{})
}
